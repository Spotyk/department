...
<div id="popupEdit" class="modal-edit">
    <div class="modal-edit-content">
        <a class="close-button"><img src="${pageContext.request.contextPath}/web_resources/img/close.png"
                                     onclick="closeEditDepartment()"></a>
        <form action="/updateDepartment" method="POST">
            <div class="input-group mb-3">
                ...
                <div class="full-width">
                    <input name="name" id="name" type="text" class="form-control" placeholder="Department Name"
...
<div id="popupCreate" class="modal-create">
    <div class="modal-edit-content">
        <a class="close-button"><img src="${pageContext.request.contextPath}/web_resources/img/close.png"
                                     onclick="closeCreateDepartment()"></a>
        <form action="/createDepartment" method="POST">
            <div class="input-group mb-3">
                ...
                <span for="newName"
                      class="nameLabel not-correct-input no-display notValidName"> Name is not valid.</span>
                <div class="full-width">
                    <input name="newName" id="newName" type="text" class="form-control" placeholder="Department Name"
                           maxlength="50" required>
                </div>
            </div>
...
<script src="${pageContext.request.contextPath}/web_resources/js/deleteDepartment.js"></script>
<script src="${pageContext.request.contextPath}/web_resources/js/createDepartment.js"></script>
