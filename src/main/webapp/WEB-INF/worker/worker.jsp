            ...
            <div class="flex-item dark-gray-color">
                <div class="flex-inline-container">
                    ...
                    <div class="flex-inline-item ">
                        ...
                        onclick="editWorker(${worker.id}, ${worker.salary}, '${worker.name}', '${worker.email}', '${worker.date}')">edit</a>
                    </div>
                    <div class="flex-inline-item ">
...
<jsp:include page="/WEB-INF/footer.jsp"/>
        ...
        <div class="modal-edit-content">
            ...
            <form action="/" method="GET">
                ...
                <div class="input-group mb-3">
                        ...
                        <span for="createEmail" class="nameLabel not-correct-input no-display duplicateEmail">Duplicate email.</span>                    <div class="full-width">
                    Email
    ...
    <script src="${pageContext.request.contextPath}/web_resources/js/popapWorker.js"></script>
