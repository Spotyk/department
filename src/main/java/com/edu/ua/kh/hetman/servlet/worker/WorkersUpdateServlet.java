...
import static com.edu.ua.kh.hetman.constant.Constant.Servlet.WORKER_UPDATE_SERVLET;

@WebServlet(WORKER_UPDATE_SERVLET)
public class WorkersUpdateServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        if (validator.isWorkerValid(workerDTO) &&
                (workerDTO.getOldEmail().equals(workerDTO.getEmail()) || !workerService.isWorkerEmailExist(workerDTO.getEmail()))) {
